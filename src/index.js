// public key:- ce8f15581f9206f33e7b819679aae23e
// md5 hash =73c973490b49ef1603d48d1c3efb77c8

function getCharacters() {
  // API call to get the data
  const char_url = `http://gateway.marvel.com/v1/public/characters?ts=1&apikey=ce8f15581f9206f33e7b819679aae23e&hash=73c973490b49ef1603d48d1c3efb77c8`;
  getCharApi(char_url);
}
getCharacters();
...
async function searchHeros(textSearched) {
  ...
  // API call to get the data
  await fetch(
    `https://gateway.marvel.com/v1/public/characters?nameStartsWith=${textSearched}&apikey=ce8f15581f9206f33e7b819679aae23e&hash=73c973490b49ef1603d48d1c3efb77c8&ts=1`
  )
...
// Function invoked when "Add to Favourites" button or "Remove from favourites" button is click appropriate action is taken accoring to the button clicked
